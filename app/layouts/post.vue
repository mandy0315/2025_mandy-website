...
<template>
  <div class="flex relative c-container">
    ...
    <div class="transition-all ease-linear sticky flex flex-col" :class="isShowSidebar ? 'w-60' : 'w-0'"
      ...
      <div class="rounded-t-full bg-primary/10 h-20 relative flex-shrink-0">
      </div>

      <aside class="bg-primary/10 overflow-hidden flex-1">
