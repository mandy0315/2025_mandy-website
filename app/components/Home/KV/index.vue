...
<template>
  <div class="w-90 h-auto flex justify-center items-center relative">
    <img src="/images/kv.webp" class="object-contain object-center filter dark:contrast-80 relative z-10" width="695"
      height="1043" alt="KV 圖" loading="eager" fetchpriority="high" />
